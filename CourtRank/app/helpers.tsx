...
export const checkIsProfanityAndAlert = (text: string): boolean => {
    if (isProfane(text)) {
        myPrint("Please avoid using inappropriate language.", "Inappropriate Language Detected");
        return true;
    }
    return false;
}

export const privatePolicy = `<h1>Privacy Policy</h1>
...
<li>
<p><strong>Application</strong> refers to CourtRank, the software program provided by the Company.</p>
</li>
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to CourtRank.</p>
</li>
<li>
...
<li>
<p><strong>Website</strong> refers to CourtRank, accessible from <a href="https://c.tekkey.net/_sitemap" rel="external nofollow noopener" target="_blank">https://c.tekkey.net/_sitemap</a></p>
</li>
<li>
...
<ul>
<li>By email: courtrankhelp@gmail.com</li>
</ul>`